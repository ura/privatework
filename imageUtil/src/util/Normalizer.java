...
public class Normalizer {
	...
	public static boolean onlyJpStr(String str) {

		return str == null ? false
				: str.matches("[\\p{InHiragana}\\p{InKatakana}\\p{InCjkUnifiedIdeographs}\\p{InBASIC_LATIN}]*");

	}

	public static String toOnlyJpStr(String str) {

		return str == null ? null
				: str.replaceAll(
						"[^\\p{InHiragana}\\p{InKatakana}\\p{InCjkUnifiedIdeographs}\\p{InBASIC_LATIN}]+",
						"");
